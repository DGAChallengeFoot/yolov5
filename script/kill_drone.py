...
class DroneShooter:
    def __init__(self, drone_N):
        assert int(drone_N) in {1, 2, 3, 4}, "Please select a valid option"
...
if __name__ == '__main__':
    try:
        ...
        print("Thefollowing drone will be shot")
        drone_N = input("Select a drone to be shot. (Options 1, 2, 3, 4): ")
